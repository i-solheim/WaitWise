...
- **Backend:** Python (data processing and prediction logic), Flask
- **Data sources:** Simulated demo data
...
- **Nat** — Backend and data (Python)

## Getting Started

Clone the repo:
```
git clone https://github.com/i-solheim/WaitWise.git
cd waitwise
```
...
Built for HackAugie, April 2026.